...
# Add entries under "<your-pkg>/_stack/proxmox/<region>/pve-nodes/pve-1/vms/test/test-ubuntu-vm-1"
# (or at the pve-1 level to set defaults for all VMs) to override:
#
...
#
# node_name, datastore_vm, and network_bridge are inherited from the pve-1
# ancestor config_params entry and do not need to be set per-VM.
# ---------------------------------------------------------------------------
