...
#
# To pin a specific build or add checksum verification, set in your
# deployment package YAML under config_params for this unit's path:
#   url:                "https://cloud-images.ubuntu.com/noble/current/noble-server-cloudimg-amd64.img"
#   file_name:          "noble-server-cloudimg-amd64.qcow2"
#   checksum_algorithm: sha256
#   checksum:           "<sha256 from the Ubuntu cloud image manifest>"
#
# node_name and datastore_iso are inherited from the pve-1 ancestor config_params entry.
# ---------------------------------------------------------------------------
